  ...
  readElements() {
    ...
    for (const element of this.elements) {
      if (element instanceof Letter) {
        results.push(this.readLetter(element));
      } else if (element instanceof Picture) {
        results.push(this.readPicture(element));
      } else if (element instanceof Movie) {
        results.push(this.readMovie(element));
      }
    }
...
console.log(myPortfolio.readElements());
